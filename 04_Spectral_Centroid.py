# Extract the spectral centroid of the audio signal.
...
sw_audio = librosa.feature.spectral_centroid(y=waveform, n_fft=1024).T[:, 0]

# 3.Plot the spectral centroid information of audio
